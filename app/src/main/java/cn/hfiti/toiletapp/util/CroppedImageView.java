...
public class CroppedImageView extends ImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener{

	private static final int BORDERDISTANCE = CroppedView.BORDERDISTANCE;
    ...
    public CroppedImageView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public CroppedImageView(Context context, AttributeSet attr, int defStyle) {
	...
	private class AnimatedZoomRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((deltaScale > 1f) && (currentScale < targetZoom))
                ...
                // again
                postOnAnimation(CroppedImageView.this, this);
