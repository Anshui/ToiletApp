...
public class Database {
	...
	mHelper = new SQLiteOpenHelper(context, "data", null, 1) {
		...
		public void onCreate(SQLiteDatabase db) {
		    db.execSQL("CREATE TABLE IF NOT EXISTS weight (_id INTEGER PRIMARY KEY AUTOINCREMENT, weight, created_at, user_id_name)");
		    db.execSQL("CREATE INDEX IF NOT EXISTS weight_created_at ON weight (created_at)");
		}
